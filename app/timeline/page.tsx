  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[260px_1fr]">
        <aside className="zen-panel hidden h-fit max-h-[calc(100vh-120px)] overflow-y-auto rounded-xl p-4 lg:sticky lg:top-20 lg:block [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-white/10 [&::-webkit-scrollbar-track]:bg-transparent">
